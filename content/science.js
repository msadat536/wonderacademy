/* Science & Nature - 30 concepts. Answer is always index 0 in source; the app shuffles choices on screen. */
window.CONTENT = window.CONTENT || {};
window.CONTENT['science'] = {
  id: 'science', title: 'Science & Nature', emoji: '🔬', color: '#3FA34D', tint: '#DFF3E2',
  concepts: [

{ id: 'sun', title: 'The Sun', emoji: '☀️', scene: ['☀️','🌍','🌻'], video: '',
young: { story: 'The Sun is a giant ball of hot, glowing gas in the sky. It gives us light and keeps us warm. Plants use sunshine to grow big and strong. Never look straight at the Sun, it is too bright for your eyes!',
questions: [
...
older: { story: 'The Sun is a star, just like the tiny stars you see at night, but it looks huge because it is much closer to Earth. It is a giant ball of burning gas, mostly hydrogen, and it is about 150 million kilometers away. Light from the Sun takes about 8 minutes to reach us. The Sun gives Earth the light and heat that plants, animals, and people need to live. More than one million Earths could fit inside the Sun!',
questions: [
...
{ id: 'moon', title: 'The Moon', emoji: '🌙', scene: ['🌙','⭐','🦉'], video: '',
young: { story: 'The Moon is our friend in the night sky. It is a big round rock that goes around the Earth. The Moon does not make its own light, it shines because sunlight bounces off it. Some nights it looks round, and some nights it looks like a banana!',
questions: [
...
older: { story: 'The Moon is Earth\'s only natural satellite, which means it travels around our planet. It takes about one month to go all the way around. The Moon has no air, no wind, and no water, and its surface is covered with dust and craters made by space rocks. It does not make light; we see it because it reflects sunlight. As the Moon moves, we see different amounts of its lit side, called phases, like the full moon and the crescent. In 1969, astronauts landed on the Moon for the very first time.',
questions: [
...
{ id: 'stars', title: 'Stars', emoji: '✨', scene: ['✨','🌌','🔭'], video: '',
young: { story: 'Stars are giant balls of hot glowing gas, very very far away. They look tiny because they are so far from us. Stars twinkle in the night sky like little lights. Our Sun is a star too, the closest one to Earth!',
questions: [
...
older: { story: 'Stars are enormous balls of burning gas that make their own light and heat, just like our Sun. They look small only because they are trillions of kilometers away. Stars come in different colors: the hottest stars glow blue-white and cooler stars glow red. Groups of stars seem to make pictures in the sky called constellations, like the Big Dipper. Long ago, sailors used the stars like a map to find their way across the ocean. Our galaxy, the Milky Way, holds more than 100 billion stars.',
questions: [
...
{ id: 'planets', title: 'The Planets', emoji: '🪐', scene: ['☀️','🪐','🌍'], video: '',
young: { story: 'Planets are big round worlds that travel around the Sun. Earth is our planet, and it has seven planet friends. Mars is red, Jupiter is the biggest, and Saturn wears beautiful rings. All together, the Sun and its planets are called the solar system!',
questions: [
...
older: { story: 'Our solar system has eight planets that orbit the Sun: Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune. Mercury is closest to the Sun and Neptune is farthest away. The four planets nearest the Sun are made of rock, while the four outer planets are giant balls of gas. Jupiter is so large that all the other planets could fit inside it. Mars looks red because its soil contains rusty iron. Earth is the only planet we know that has liquid water and living things.',
questions: [
...
{ id: 'earth', title: 'Our Planet Earth', emoji: '🌍', scene: ['🌍','🌊','🏔️'], video: '',
young: { story: 'Earth is our home planet, a big blue and green ball in space. The blue parts are oceans full of water, and the green and brown parts are land. Earth has air for us to breathe and water for us to drink. It is the perfect home for people, animals, and plants!',
questions: [
...
older: { story: 'Earth is the third planet from the Sun and the only place we know with life. About 70 percent of its surface is covered by ocean, which is why Earth looks blue from space. Earth spins like a top, making day and night, and travels around the Sun once every year. A blanket of air called the atmosphere surrounds our planet, giving us oxygen to breathe and protecting us from the Sun\'s harmful rays. Deep inside, Earth has layers: the crust we stand on, the hot mantle, and a super-hot metal core.',
questions: [
...
{ id: 'day-night', title: 'Day and Night', emoji: '🌗', scene: ['🌅','🌍','🌃'], video: '',
young: { story: 'Earth is always slowly spinning like a top. When our side of Earth faces the Sun, it is daytime and bright. When our side turns away from the Sun, it is nighttime and dark. That is why the Sun seems to rise in the morning and go away at night!',
questions: [
...
older: { story: 'Earth rotates, or spins, on an invisible line called its axis, making one full turn every 24 hours. The side facing the Sun has daytime while the opposite side has night. This means that when it is morning where you live, it is already evening on the other side of the world. Sunrise happens as your part of Earth turns toward the Sun, and sunset happens as it turns away. The Sun never actually moves across the sky; it only looks that way because we are the ones spinning!',
questions: [
...
{ id: 'seasons', title: 'The Seasons', emoji: '🍂', scene: ['🌸','☀️','🍂','⛄'], video: '',
young: { story: 'A year has four seasons: spring, summer, fall, and winter. In spring, flowers bloom and baby animals are born. Summer is hot and sunny, perfect for the beach. In fall, leaves turn orange and red and float down. Winter is cold, and in some places it snows!',
questions: [
...
older: { story: 'Earth travels around the Sun once a year while tilted to one side, like a leaning spinning top. This tilt causes the seasons. When your half of Earth leans toward the Sun, sunlight hits it more directly and you get summer with long, warm days. When your half leans away, you get winter with short, cold days. Spring and fall happen in between. That is also why seasons are opposite in the two halves of the world: when it is summer in America, it is winter in Australia!',
questions: [
...
{ id: 'water-cycle', title: 'The Water Cycle', emoji: '💧', scene: ['🌊','☁️','🌧️','🏞️'], video: '',
young: { story: 'Water goes on an amazing journey called the water cycle. The Sun warms up water in the sea, and tiny bits of it float up into the sky. Up high, they turn into clouds. When clouds get heavy, the water falls back down as rain. Then the journey starts all over again!',
questions: [
...
older: { story: 'The water cycle moves water around our planet again and again. The Sun heats water in oceans, lakes, and rivers, turning it into an invisible gas called water vapor; this is evaporation. The vapor rises, cools down, and turns back into tiny droplets that form clouds; this is condensation. When the droplets grow too heavy, they fall as rain or snow; this is precipitation. The water then flows through rivers back to the ocean, and the cycle begins again. The water you drank today may once have floated in a cloud or splashed in an ancient ocean!',
questions: [
...
{ id: 'clouds', title: 'Clouds', emoji: '☁️', scene: ['☁️','⛅','🌥️'], video: '',
young: { story: 'Clouds are made of millions of tiny water drops floating in the sky. Fluffy white clouds mean nice weather. Dark gray clouds are full of water and can bring rain. Have you ever seen a cloud shaped like an animal?',
questions: [
...
older: { story: 'Clouds form when water vapor in the air cools and condenses into billions of tiny droplets or ice crystals. Different clouds tell us different things about the weather. Cumulus clouds look like fluffy cotton and usually mean fair weather. Stratus clouds spread across the sky in flat gray layers and can bring drizzle. Cirrus clouds are thin and wispy, very high up, made of ice crystals. Towering cumulonimbus clouds are storm giants that bring thunder, lightning, and heavy rain. Fog is simply a cloud that forms right at the ground!',
questions: [
...
{ id: 'rain-snow', title: 'Rain and Snow', emoji: '🌧️', scene: ['🌧️','❄️','⛄'], video: '',
young: { story: 'Rain is water falling from clouds in little drops. Rain helps plants drink and fills up rivers and puddles. When it is very cold, the water freezes and falls as soft white snow instead. Snowflakes are tiny ice stars, and every one is different!',
questions: [
...
older: { story: 'Rain and snow are both precipitation, water falling from clouds. Inside a cloud, tiny droplets bump together and join until they are heavy enough to fall as raindrops. If the air is freezing cold, water vapor turns straight into ice crystals that stick together as snowflakes. Every snowflake has six sides or points, but no two are exactly alike. Rain and melted snow fill rivers, water crops, and refill the underground water we drink. Too much rain at once can cause floods, while too little for a long time causes a drought.',
questions: [
...
{ id: 'wind', title: 'Wind', emoji: '🌬️', scene: ['🌬️','🍃','🪁'], video: '',
young: { story: 'Wind is air that is moving. You cannot see wind, but you can feel it on your face and see it move the trees. Wind can fly a kite, push a sailboat, and make leaves dance. Strong wind is called a storm wind, and soft wind is called a breeze!',
questions: [
...
older: { story: 'Wind is air moving from one place to another. It happens because the Sun heats Earth unevenly: warm air rises, and cooler air rushes in to take its place. That rushing air is wind! Gentle winds are breezes, while very strong spinning winds can become tornadoes and hurricanes. People have used wind power for thousands of years to sail ships and turn windmills. Today, giant wind turbines turn wind into clean electricity for our homes.',
questions: [
...
{ id: 'thunder', title: 'Thunder and Lightning', emoji: '⛈️', scene: ['⛈️','⚡','🌩️'], video: '',
young: { story: 'In a big storm, you might see lightning, a giant flash of electricity in the sky. After the flash comes thunder, a big rumbling BOOM! Lightning is very powerful, so during a storm we stay safe inside. Thunder cannot hurt you, it is just a loud sound!',
questions: [
...
older: { story: 'Inside a storm cloud, ice crystals and water droplets crash around and build up electric charge, like rubbing a balloon on your hair but millions of times stronger. When the charge grows big enough, it jumps as a giant spark: lightning! Lightning is five times hotter than the surface of the Sun, and it heats the air so fast that the air explodes outward, making the sound we call thunder. Light travels faster than sound, so we see the flash before we hear the boom. Counting the seconds between them tells you how far away the storm is!',
questions: [
...
{ id: 'rainbows', title: 'Rainbows', emoji: '🌈', scene: ['🌦️','🌈','☀️'], video: '',
young: { story: 'A rainbow is a big arch of colors in the sky. Rainbows appear when the Sun shines through raindrops. The colors are red, orange, yellow, green, blue, and purple. Look for a rainbow when the Sun comes out right after the rain!',
questions: [
...
{ id: 'volcanoes', title: 'Volcanoes', emoji: '🌋', scene: ['🌋','🔥','🏔️'], video: '',
young: { story: 'A volcano is a special mountain with a hole at the top. Deep under the ground there is super hot melted rock called lava. Sometimes the volcano erupts, and lava shoots out with smoke and ash! When lava cools down, it turns into hard black rock.',
questions: [
...
{ id: 'mountains', title: 'Mountains', emoji: '🏔️', scene: ['🏔️','🦅','🌲'], video: '',
young: { story: 'Mountains are giant hills of rock that reach up toward the sky. The tallest mountains have snow on top all year, even in summer! Mountain goats and eagles love living on mountains. The tallest mountain in the whole world is called Mount Everest.',
questions: [
...
{ id: 'rivers', title: 'Rivers and Lakes', emoji: '🏞️', scene: ['🏞️','🦆','🐟'], video: '',
young: { story: 'A river is water that flows across the land, always moving toward the sea. A lake is water with land all around it, like a big bowl of water. Fish, ducks, and frogs love living in rivers and lakes. Rivers start small in the mountains and grow bigger and bigger!',
questions: [
...
{ id: 'oceans', title: 'The Ocean', emoji: '🌊', scene: ['🌊','🐋','🐠'], video: '',
young: { story: 'The ocean is a giant sea of salty water that covers most of our planet. It is home to fish, dolphins, whales, and colorful coral. The ocean has waves that roll onto the beach, splash! Some parts of the ocean are so deep that sunlight cannot reach the bottom.',
questions: [
...
{ id: 'deserts', title: 'Deserts', emoji: '🏜️', scene: ['🏜️','🐪','🌵'], video: '',
young: { story: 'A desert is a very dry place where it almost never rains. Many deserts are hot and covered with golden sand. Camels, lizards, and cactus plants know how to live with very little water. At night, the hot desert can get surprisingly cold!',
questions: [
...
older: { story: 'A desert is any place that gets very little rain, less than about 25 centimeters a year. The Sahara in Africa is the largest hot desert, but surprisingly, the biggest desert of all is freezing Antarctica, because deserts are about dryness, not heat! Desert plants and animals have clever tricks to survive: cactuses store water in their thick stems, camels can go days without drinking, and many animals hide underground by day and come out in the cool night. Hot deserts can swing from burning days to near-freezing nights because there are few clouds to hold the heat in.',
questions: [
...
{ id: 'rainforests', title: 'Rainforests', emoji: '🌴', scene: ['🌴','🦜','🐒'], video: '',
young: { story: 'A rainforest is a thick, green forest where it rains almost every day. The trees grow so tall and close together that they make a leafy roof called the canopy. Monkeys swing from branches, parrots fly in bright colors, and jaguars sneak below. More animals live in rainforests than anywhere else on land!',
questions: [
...
{ id: 'rocks', title: 'Rocks and Minerals', emoji: '🪨', scene: ['🪨','💎','⛏️'], video: '',
young: { story: 'Rocks are hard pieces of the Earth. Some are big like boulders and some are tiny like pebbles. Rocks can be gray, brown, red, or even sparkly! Shiny crystals and gems like diamonds are special rocks called minerals.',
questions: [
...
{ id: 'fossils', title: 'Fossils and Dinosaurs', emoji: '🦖', scene: ['🦖','🦴','⛏️'], video: '',
young: { story: 'Long, long ago, before people, giant dinosaurs walked the Earth! When ancient animals died, some of their bones slowly turned into stone. These stone bones are called fossils. Scientists dig up fossils to learn about dinosaurs, like the mighty T-rex and the long-necked Brachiosaurus.',
questions: [
...
{ id: 'soil', title: 'Soil', emoji: '🪱', scene: ['🌱','🪱','🍄'], video: '',
young: { story: 'Soil is the soft brown dirt that covers the ground. It is made of tiny bits of rock, old leaves, and water. Plants push their roots into soil to drink and stand up tall. Wiggly earthworms live in soil and help make it healthy!',
questions: [
...
{ id: 'air', title: 'Air All Around Us', emoji: '💨', scene: ['💨','🎈','🍃'], video: '',
young: { story: 'Air is all around us, even though we cannot see it. We breathe air in and out all day and night. Air fills up balloons and bubbles, and moving air is the wind. Every person, animal, and plant needs air to live!',
questions: [
...
older: { story: 'Air is a mixture of invisible gases: mostly nitrogen, then oxygen, the gas our bodies need, plus small amounts of others like carbon dioxide. When we breathe in, our lungs take oxygen from the air; when we breathe out, we release carbon dioxide, which plants then use to make their food. So animals and plants trade gases in a perfect partnership! Air also has weight and pushes on everything; this push is called air pressure. The blanket of air around Earth, the atmosphere, protects us from space rocks and the Sun\'s harmful rays.',
questions: [
...
{ id: 'matter', title: 'Solid, Liquid, Gas', emoji: '🧊', scene: ['🧊','💧','💨'], video: '',
young: { story: 'Everything around us comes in three forms: solid, liquid, and gas. A solid keeps its shape, like an ice cube or a toy block. A liquid flows and takes the shape of its cup, like water or juice. A gas floats and spreads everywhere, like the air in a balloon. Water can be all three: ice, water, and steam!',
questions: [
...
older: { story: 'Matter is everything that takes up space, and it usually comes in three states: solid, liquid, and gas. In a solid, tiny particles are packed tightly and only wiggle in place, so solids hold their shape. In a liquid, particles slide past each other, so liquids flow and take the shape of their container. In a gas, particles zoom around freely and spread out to fill any space. Heating or cooling changes the state: ice melts into water at 0 degrees Celsius, and water boils into steam at 100 degrees. Freezing, melting, boiling, and condensing happen around you every day!',
questions: [
...
{ id: 'hot-cold', title: 'Hot and Cold', emoji: '🌡️', scene: ['🔥','🌡️','❄️'], video: '',
young: { story: 'Some things are hot, like soup and sunshine. Some things are cold, like ice cream and snow. We use a thermometer to measure how hot or cold something is. Heat likes to travel: that is why hot cocoa warms your hands and an ice pop cools your mouth!',
questions: [
...
{ id: 'floating', title: 'Floating and Sinking', emoji: '⛵', scene: ['⛵','🦆','🪨'], video: '',
young: { story: 'When you put things in water, some float on top and some sink to the bottom. A rubber duck floats, but a rock sinks, splash! Light things full of air usually float. Big ships float too because they have lots of air inside, like a giant bathtub toy!',
questions: [
...
{ id: 'recycling', title: 'Caring for Our Earth', emoji: '♻️', scene: ['♻️','🌍','💚'], video: '',
young: { story: 'Our Earth is our only home, so we must take care of it! We can recycle paper, plastic, and cans so they can be made into new things. We can save water, pick up trash, and plant trees. When we keep Earth clean, animals, plants, and people all stay happy and healthy!',
questions: [
...
{ id: 'tides', title: 'Waves and Tides', emoji: '🌊', scene: ['🌊','🌙','🏖️'], video: '',
young: { story: 'Ocean water is always moving. Wind blowing across the sea makes waves that roll and crash on the beach. The ocean also slowly rises and falls every day, like the sea breathing in and out; that is called the tide. At low tide, you can find crabs and shells in little pools left on the beach!',
questions: [
...
{ id: 'comets', title: 'Comets and Shooting Stars', emoji: '☄️', scene: ['☄️','🌠','🌌'], video: '',
young: { story: 'A shooting star is not really a star: it is a tiny space rock burning up as it zooms into the sky! It makes a bright streak of light for just a second. Comets are big balls of ice and dust that fly around the Sun with long glowing tails. If you see a shooting star, you can make a wish!',
questions: [
